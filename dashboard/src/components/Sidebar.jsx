...
export default function Sidebar({ activePage, onNavigate }) {
  ...
  return (
    <aside
      className="fixed top-0 left-0 h-screen w-64 bg-surface
      ...
      <div className="px-5 py-5 border-b border-border flex-shrink-0">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            ...
            <p className="text-textsecondary text-xs">UCI HAR Dataset</p>
          </div>
        </div>

        {/* Project completion badge */}
        <div
          className="flex items-center gap-2 bg-green-400/10
            ...
            return (
              <div key={model} className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  />
                  <span className="text-textsecondary text-xs">{model}</span>
                </div>
